...
% Some extra hooks
\providecommand{\HookSetChapterFont}[0]{}
\providecommand{\HookSetSectionFont}[0]{}
\providecommand{\HookSetSubsectionFont}[0]{}
...
\newlength{\VspacePreSection}
\setlength{\VspacePreSection}{0pt}

\newlength{\VspacePreSubsection}
\setlength{\VspacePreSubsection}{0pt}

% Chapter
\titleformat{\chapter}[display]{\sffamily\large\bfseries}%
{\sffamily\MakeUppercase{\chaptertitlename}~\thechapter}{10pt}{\sffamily\huge\HookSetChapterFont}%
[\vspace{0pt}\AlrightTeXChapterEnder]

% Section
\newlength{\sectionleaderwidth}
\setlength{\sectionleaderwidth}{72pt}
\newlength{\subsectionleaderwidth}
\setlength{\subsectionleaderwidth}{72pt}
\titleformat{\section}[display]{\vspace{\VspacePreSubsection}\sffamily\large\bfseries}%
{}{0pt}{\sffamily\bfseries\LARGE\HookSetSectionFont\makebox[\sectionleaderwidth]{\AlrightTeXSectionLeader\thesection\hfill}}[]%

% Subsection
\titleformat{\subsection}[display]{\vspace{\VspacePreSubsection}\sffamily\large\bfseries}%
{}{0pt}{\sffamily\bfseries\Large\HookSetSubsectionFont\makebox[0.75\subsectionleaderwidth]{\thesubsection\hfill}}[]%
